let data = 0;
  ...
  if(x=="2")
  {
    document.getElementById("a").innerHTML=60000*data;
  }
  else if(x=="3")
  {
    document.getElementById("a").innerHTML=80000*data;
  }
  else{
  ...
  function getprice2() {
    ...
    if (selectedValue === "22 Carat") {
      document.getElementById('b').textContent = 90000 * data1;
    } else if (selectedValue === "24 Carat") {
      document.getElementById('b').textContent = 120000 * data1;
    } else {
...
function getprice3() {
  ...
  if (z == "2") {
    document.getElementById("c").innerHTML = 40000 * data2;
  } else if (z == "3") {
    document.getElementById("c").innerHTML = 60000 * data2;
  } else {
